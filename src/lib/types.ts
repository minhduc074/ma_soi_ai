...
export const ROLE_INFO: Record<Role, { name: string; emoji: string; team: 'wolf' | 'village'; description: string }> = {
  werewolf: {
    ...
    emoji: '🐺',
    team: 'wolf',
    description: 'Mỗi đêm, bạn cùng đồng đội chọn một người để giết. Ban ngày, hãy ngụy trang thành dân làng.',
  },
  villager: {
    name: 'Dân làng',
    emoji: '👤',
  ...
  guard: {
    ...
    emoji: '🛡️',
    team: 'village',
    description: 'Mỗi đêm, bạn chọn một người để bảo vệ khỏi bị sói giết. Không được bảo vệ cùng một người 2 đêm liên tiếp.',
  },
  witch: {
    name: 'Phù thủy',
    emoji: '🧙',
    team: 'village',
    description: 'Bạn có 1 bình thuốc cứu và 1 bình thuốc độc. Mỗi đêm bạn có thể dùng tối đa 1 bình.',
  },
  hunter: {
    name: 'Thợ săn',
    emoji: '🏹',
    team: 'village',
    description: 'Khi bạn bị giết (bởi sói hoặc bị vote), bạn có thể bắn chết một người khác.',
  },
};
